...
export default async function AdminOverview() {
  ...
  const stats = [
    { value: projectCount, label: "Projets au portfolio", href: "/admin/projects" },
    { value: unreadCount, label: "Messages non lus", href: "/admin/messages" },
    { value: messageCount, label: "Messages au total", href: "/admin/messages" },
  ];
